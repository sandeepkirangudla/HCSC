...
The final step is generate the result. <i>my_func.SummaryStats.summarize</i> generates the summary file as a csv because it is very easy to interpret and do custom analysis on csv.
...
from HCSC.config import *
from HCSC.data_clean import *
from HCSC.data_process import *
from HCSC.config import *
from HCSC.IO_path import *
from HCSC.merge import *
from HCSC.summary_stats import *
from HCSC.HSCS import *
